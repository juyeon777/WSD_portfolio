...
<strong>협력 기업 ·</strong> (주)헤드아이티<br>
시뮬레이션이 아닌 <strong>실증 농가의 실기기·실데이터</strong>로 end-to-end 검증까지 진행
</div>

...
- The research predicts city-bus passenger demand without alighting data, using transportation-card big data and reboarding counts (comparing Random Forest, XGBoost, LightGBM — LightGBM most stable).
